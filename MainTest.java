...
//			}
	...
	public void run() {
		...
		String host = "tcp://10.4.44.210:8020";//tcp://10.4.45.133:61613,tcp://10.4.44.210:8020
...
class MainTest2 implements Runnable{
	...
	public void run() {
		...
		String host = "tcp://10.4.44.210:8020";
		String username = "admin";
		String password = "password";
		String reseivetopic = "Topics/htjs/serverToPhone";
		try {
